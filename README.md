...
Then, just browse to [mlocal.crunchbase.com](http://mlocal.crunchbase.com) and you are ready to start developing!
...
Remember to put all domains you're going to hit in your etc/hosts if you run your server with the `-auto-hosts=false` option.
    ...
    127.0.0.1   mlocal.crunchbase.com
    127.0.0.1   mlocal.m.crunchbase.com
    127.0.0.1   mlocal.link.crunchbase.com
    127.0.0.1   mlocal.info.crunchbase.com
    127.0.0.1   mlocal.developer.crunchbase.com
